...
import com.platzerworld.biergartenfinder.rest.parsers.FlowerXMLParser;
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isOnline()) {
                    ...
                    Toast.makeText(ParseXMLActivity.this, "Network isn't available", Toast.LENGTH_LONG).show();
                }
            }
        });
