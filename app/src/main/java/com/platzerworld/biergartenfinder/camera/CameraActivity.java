...
public class CameraActivity extends AppCompatActivity {
    ...
    private static final int ACTION_TAKE_PHOTO_A = 4;
    ...
    private File setUpPhotoFile1() throws IOException {
        File photoFile = createImageFile1();
        mCurrentPhotoPath = photoFile.getAbsolutePath();
        return photoFile;
    }
    ...
    private void dispatchTakePictureIntent(int actionCode) {
        ...
        switch(actionCode) {
            ...
            case ACTION_TAKE_PHOTO_A:
                ...
                try {
                    photoFile1 = setUpPhotoFile1();
                    mCurrentPhotoPath = photoFile1.getAbsolutePath();

                    Uri photoURI = FileProvider.getUriForFile(this,
                            "com.platzerworld.biergartenfinder.fileprovider",
                            photoFile1);
    ...
    Button.OnClickListener mTakePicAOnClickListener =
            new Button.OnClickListener() {
                @Override
                public void onClick(View v) {
